...
public class ControllerPrincipal implements ActionListener, ChangeListener {
    ...
    public void actionPerformed(ActionEvent e) {
        /**
         * Se for o pressionar do botao 'Gerar Numero' da FrameMain, instancia
         * uma DialogGerarNumero
         */
    ...
    public void stateChanged(ChangeEvent e) {
        if (this.dialogGerarNumero != null) {
            /**
             * A medida que o Slider eh arrastado, o campo equivalente na
             * FramePrincipal tem seu valor alterado
             */
    ...
    /**
     * Metodo responsavel em controlar a acao de ordenacao. Redireciona para a
     * Model
     */
